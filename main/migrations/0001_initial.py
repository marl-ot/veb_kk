# Generated by Django 4.0.3 on 2022-05-17 05:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school_number', models.IntegerField(blank=True, max_length=10, verbose_name='Номер школы')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_letter', models.CharField(default="what's letter?", max_length=2, verbose_name='Буква класса')),
            ],
        ),
        migrations.CreateModel(
            name='DoneWorks',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('done_work', models.ImageField(default='current_map', upload_to='done_map/%Y/%m/%d/', verbose_name='Готовая работа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('work', models.ImageField(default='base_map', upload_to='base_maps/%Y/%m/%d/', verbose_name='Работа')),
                ('legend', models.CharField(default='text', max_length=255, verbose_name='Легенда')),
                ('task', models.CharField(default='text', max_length=255, verbose_name='Задание')),
            ],
        ),
        migrations.CreateModel(
            name='Grades',
            fields=[
                ...
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='My_teacher', to=settings.AUTH_USER_MODEL, verbose_name='Учитель')),
